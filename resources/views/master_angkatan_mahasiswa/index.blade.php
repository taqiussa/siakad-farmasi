...
@section('content')
    <script>
        ...
        function fetch_user_data() {
            ...
            $.ajax({
                type: "get",
                url: "master_angkatan_mahasiswa/get_master_angkatan_mahasiswa?page=" + page + "&search=" + search,
        ...
        function delete_data(id_angkatan_mahasiswa) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "get",
                        url: "/master_angkatan_mahasiswa/delete_master_angkatan_mahasiswa/" + id_angkatan_mahasiswa,
                        beforeSend: function() {
                            loading();
                        },
    ...
    <div class="card bg-light shadow-sm">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ URL::to('/master_angkatan_mahasiswa/add_master_angkatan_mahasiswa') }}" type="button" class="btn btn-primary" data-bs-toggle="tooltip"
        ...
        <div class="card-body card-scroll">
            <form method="get" action="/master_angkatan_mahasiswa">
                <div class="d-flex align-items-center position-relative my-1">
                    <input type="text" data-kt-docs-table-filter="search" name="search" id="search"
                        class="form-control form-control-solid w-250px ps-15" placeholder="Cari Nama Angkatan" />
                </div>
            </form>
