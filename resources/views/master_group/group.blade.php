...
@section('content')
    <script>
        ...
        function fetch_user_data() {
            ...
            $.ajax({
                type: "get",
                url: "{{ URL::to('master_group/get_master_group_pagination/')}}?id_master_aplikasi=" + id_master_aplikasi +
                    "&page=" + page +
                    "&search=" + search,
        ...
        function delete_data(id_master_group) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "get",
                        url: "{{ URL::to('master_group/delete_master_group')}}/" + id_master_group,
                        beforeSend: function() {
                            loading();
                        },
        ...
        <div class="card-body pt-9 pb-0">
            <div class="d-flex flex-wrap flex-sm-nowrap mb-6">
                <div
                    ...
                    <img class="mw-100px mw-lg-100px" src="/images/{{ $master_aplikasi->image }}" alt="image">
                </div>
                <div class="flex-grow-1">
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <a href="{{ URL::to('/' . $add . '/' . $master_aplikasi->id_master_aplikasi) }}"
