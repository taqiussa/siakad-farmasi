...
@section('content')
    <script>
        ...
        function fetch_user_data() {
            ...
            $.ajax({
                type: "get",
                url: "master_kode_pembayaran/get_master_kode_pembayaran?page=" + page + "&search=" + search,
        ...
        function delete_data(id_kode_pembayaran) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "get",
                        url: "/master_kode_pembayaran/delete_master_kode_pembayaran/" + id_kode_pembayaran,
                        beforeSend: function() {
                            loading();
                        },
    ...
    <div class="card bg-light shadow-sm">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ $add }}" type="button" class="btn btn-primary" data-bs-toggle="tooltip"
                    ...
                    Tambah Master Kode Pembayaran
                </a>
            </div>
        </div>
        <div class="card-body card-scroll">
            <form method="get" action="/master_matakuliah">
                <div class="d-flex align-items-center position-relative my-1">
                    <input type="text" data-kt-docs-table-filter="search" name="search" id="search"
                        class="form-control form-control-solid w-250px ps-15" placeholder="Cari Kode/Nama Rekening" />
                </div>
            </form>
