...
@section('content')
    <script>
        ...
        function fetch_user_data() {
            ...
            $.ajax({
                type: "get",
                url: "master_kurikulum/get_master_kurikulum?page=" + page + "&search=" + search,
        ...
        function delete_data(id_kurikulum) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "get",
                        url: "/master_kurikulum/delete_master_kurikulum/" + id_kurikulum,
                        beforeSend: function() {
                            loading();
                        },
    ...
    <div class="card bg-light shadow-sm">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ URL::to('/master_kurikulum/add_master_kurikulum') }}" type="button" class="btn btn-primary" data-bs-toggle="tooltip"
        ...
        <div class="card-body card-scroll">
            <form method="get" action="/master_kurikulum">
                <div class="d-flex align-items-center position-relative my-1">
                    <input type="text" data-kt-docs-table-filter="search" name="search" id="search"
                        class="form-control form-control-solid w-250px ps-15" placeholder="Cari Nama Kurikulum" />
                </div>
            </form>
