...
@section('content')
    <script>
        ...
        function fetch_user_data() {
            ...
            $.ajax({
                type: "get",
                url: "master_mahasiswa/get_master_mahasiswa?page=" + page + "&search=" + search,
        ...
        function delete_data(id_registrasi_mahasiswa) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "get",
                        url: "/master_mahasiswa/delete_master_mahasiswa/" + id_registrasi_mahasiswa,
                        beforeSend: function() {
                            loading();
                        },
    ...
    <div class="card bg-light shadow-sm">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ URL::to('/master_mahasiswa/add_master_mahasiswa') }}" type="button" class="btn btn-primary" data-bs-toggle="tooltip"
        ...
        <div class="card-body card-scroll">
            <form method="get" action="/master_mahasiswa">
