...
@section('content')
    <script>
        ...
        function fetch_user_data() {
            ...
            $.ajax({
                type: "get",
                url: "master_matakuliah/get_master_matakuliah?page=" + page + "&search=" + search,
        ...
        function delete_data(id_matkul) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "get",
                        url: "/master_matakuliah/delete_master_matakuliah/" + id_matkul,
                        beforeSend: function() {
                            loading();
                        },
    ...
    <div class="card bg-light shadow-sm">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ URL::to('/master_matakuliah/add_master_matakuliah') }}" type="button" class="btn btn-primary" data-bs-toggle="tooltip"
            ...
            <form method="get" action="/master_matakuliah">
                <div class="d-flex align-items-center position-relative my-1">
                    <input type="text" data-kt-docs-table-filter="search" name="search" id="search"
                        class="form-control form-control-solid w-250px ps-15" placeholder="Cari Kode/Nama Matakuliah" />
                </div>
            </form>
