...
@section('content')
    <script>
        ...
        function fetch_user_data() {
            ...
            $.ajax({
                type: "get",
                url: "/master_angkatan_mahasiswa/get_tagihan_angkatan_pagination?id_angkatan_mahasiswa=" +
        ...
        function delete_data(id_tagihan_angkatan) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "get",
                        url: "{{ URL::to('/master_angkatan_mahasiswa/delete_tagihan') }}/" + id_tagihan_angkatan,
                        beforeSend: function() {
                            loading();
                        },
                        success: function(resp) {
    ...
    <div id="kt_content_container" class="container">
        ...
        <div class="d-flex flex-wrap flex-stack mb-6">
            <!--begin::Heading-->
            <h3 class="fw-bolder my-2">Daftar Tagihan Angakatan
            </h3>
            ...
            <div class="card-header">
                <h3 class="card-title">
                    <input type="text" data-kt-docs-table-filter="search" name="search" id="search"
                        class="form-control form-control-solid w-350px ps-15" placeholder="Cari Kode/Nama Tagihan" />
                </h3>
                <div class="card-toolbar">
                    <div class="example-tools justify-content-center">
                        <span class="example-toggle" data-toggle="tooltip" title=""
